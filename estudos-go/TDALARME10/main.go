...
func main() {
	...
	for i := 0; i < len(respostas2.Response.TrsrBdTradgList); i++ {

		fmt.Printf("\n\n\n")
		fmt.Printf("\n\n\n Valor do Site TD")

		fmt.Printf("\n\n%+v", respostas2.Response.TrsrBdTradgList[i].TrsrBd.Nm)
		fmt.Printf("\n\n%+v", respostas2.Response.TrsrBdTradgList[i].TrsrBd.MinInvstmtAmt)
		fmt.Printf("\n\n%+v", respostas.Result.SymbolCollectionItems[i].AskOffer.MinTick)
